...
/**
 * CALL.  GET_TABLE  Gets a value from a TABLE in persist.  You can only 
 ...
 * IGNORES: 
 * PARAMETERS (INPUT):
 * name= name of the table inwhich to insert.  REQUIRED
 * n= name of the table entry to get REQUIRED
 * </pre>
 ...
 */
public class Call_GET_TABLE extends Call {
