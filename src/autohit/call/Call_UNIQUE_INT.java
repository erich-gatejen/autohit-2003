...
/**
 * UNIQUE_INT call.  Returns unique integer.  It is unique to the SystemContext.
 * It is as a suitable unique ID for core items.
 * <pre>
 * REQURIES: logger
 * IGNORES: uni, core
 * </pre>
 ...
 * @version 1.0
 * <i>Version History</i>
 * <code>EPG - Initial - 30Jul03 
 * 
 */
public class Call_UNIQUE_INT extends Call {
	...
	public String call() throws CallException {
		String val = Integer.toString(sc.uniqueInteger());
