...
/**
 * A Virtual Machine instruction.  GOTO instruction.
 * It will be sensitive to scope frames.
 *
 ...
 * 
 */
public class VMIGoto extends VMInstruction {
	...
	public String toString() {
		return "VMIGoto " + super.toString() + ": --- target=" + t;
	}
